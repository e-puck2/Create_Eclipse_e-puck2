...
-The parameter "Eclipse->preferences->C/C++->New C/C++Project Wizard->Makefile Project->Discovery Options->Automate discovery of pathsand symbol" has been checked in order to automatically find the folders to include to the project to have the Code Analysis working correctly.
