...
\begin{figure}[!h]
\centering
\includegraphics[width=1\columnwidth]{fig/Eclipse_Mobots_Folder_Windows}
\caption{Eclipse\_Mobots folder obtained after extraction}
\label{fig:Eclipse_Mobots_Folder_Windows}
\end{figure}
...
\begin{enumerate}
\item Open zadig-2.3.exe located in the \path{Eclipse_Mobots\Tools\} you installed before.
